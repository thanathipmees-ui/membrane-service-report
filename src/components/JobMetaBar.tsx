...
import { Building2, Wrench, CalendarDays, Edit3 } from 'lucide-react';
...
export const JobMetaBar: React.FC<JobMetaBarProps> = ({ totalCount, headerConfig, onEditHeader }) => {
  ...
  return (
    <div className="bg-white border border-slate-200 rounded-2xl shadow-lg shadow-slate-900/5 grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-slate-200 overflow-hidden text-slate-800 relative group">
      <div className="p-4 sm:p-5 flex items-start justify-between gap-3 bg-gradient-to-br from-slate-50/50 to-white">
        ...
        {onEditHeader && (
          <button
            ...
            title="แก้ไขข้อมูลลูกค้า/หัวข้อ"
          >
